...
highest_precision([P|[]], P).
highest_precision([approx|PS], approx).
highest_precision([exact|PS], P) :- highest_precision(PS, P).

reverse(exact, approx).
reverse(approx, exact).
...
check_quartine_single(X, Y, W, Z, Precision) :- are_in_rhyme(X, Y, P1), are_in_rhyme(Y, W, P2), are_in_rhyme(W, Z, P3),
    highest_precision([P1, P2, P3], Precision).

%AAAA AAAA AAAA
check_mono([X, Y, W, Z, A, B, C, D]) :- check_quartine_single(X, Y, W, Z, P1), check_quartine_single(A, B, C, D, P2), are_in_rhyme(Z, A, P3),
    highest_precision([P1, P2, P3], Precision).

%AAAA BBBB CCCC 
check_quartine([X, Y, W, Z, A, B, C, D], Precision) :- check_quartine_single(X, Y, W, Z, P1), check_quartine_single(A, B, C, D, P2),
    highest_precision([P1, P2], Precision).
...
check_incatenated_single(X, Y, W, Precision) :- are_in_rhyme(X, W, P1), \+ are_in_rhyme(Y, W, P2), reverse(P2, P3)
    highest_precision([P1, P3], Precision).

%ABA BCB CDC DED
check_incatenated([X, Y, W, Z, A, B, C, D], Precision) :- check_incatenated_single(X, Y, W, P1), check_incatenated_single(Z, A, B, P2),
    are_in_rhyme(Y, Z, P3), are_in_rhyme(A, C, P4), \+ are_in_rhyme(C, D, P5), reverse(P5, P6),
    highest_precision([P1, P2, P3, P4, P6], Precision)
...
check_english_sonet([V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14], Precision) :- check_concatenated(V1, V2, V3, V4, V5, V6, V7, V8, P1), check_concatenated_single(V9, V10, V11, V12, P2), are_in_rhyme(V13, V14, P3),
    \+ are_in_rhyme(V1, V5, P4), \+ are_in_rhyme(V1, V6, P5a), \+ are_in_rhyme(V1, V9, P6a), \+ are_in_rhyme(V1, V10, P7a), \+ are_in_rhyme(V1, V13, P8a),
    \+ are_in_rhyme(V2, V5), \+ are_in_rhyme(V2, V6), \+ are_in_rhyme(V2, V9), \+ are_in_rhyme(V2, V10), \+ are_in_rhyme(V2, V13),
    \+ are_in_rhyme(V5, V9, P9a), \+ are_in_rhyme(V5, V10, P10a), \+ are_in_rhyme(V5, V13, P11a),
    \+ are_in_rhyme(V6, V9, P12a), \+ are_in_rhyme(V6, V10, P13a), \+ are_in_rhyme(V6, V13, P14a),
    \+ are_in_rhyme(V9, V13, P15a),
    \+ are_in_rhyme(V10, V13, P16a),
    map(reverse, [P5a, P6a, P7a, P8a, P9a, P10a, P11a, P12a, P13a, P14a, P15a, P16a], reversed),
    highest_precision([P1, P2, P3, P4 | reversed], Precision)
